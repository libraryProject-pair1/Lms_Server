...
namespace Persistence.Migrations
{
    ...
    [Migration("20240509185939_ChangeDb")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("87f0867e-6cee-47e1-a3bb-588fcbdd731c"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 174, 166, 128, 217, 126, 215, 54, 198, 25, 33, 110, 251, 225, 108, 182, 73, 237, 158, 101, 116, 60, 221, 213, 29, 151, 203, 166, 57, 47, 129, 211, 191, 146, 170, 147, 83, 246, 43, 64, 176, 220, 215, 36, 168, 48, 160, 179, 76, 5, 83, 29, 59, 182, 214, 152, 80, 181, 148, 62, 68, 92, 214, 12, 115 },
                            PasswordSalt = new byte[] { 102, 78, 43, 152, 24, 149, 181, 197, 203, 247, 29, 19, 225, 152, 19, 114, 147, 171, 171, 73, 83, 249, 206, 92, 180, 18, 121, 197, 25, 69, 125, 102, 221, 87, 235, 45, 197, 155, 28, 213, 40, 33, 7, 74, 235, 240, 193, 207, 72, 79, 203, 193, 10, 18, 13, 209, 167, 72, 200, 230, 26, 222, 190, 213, 94, 113, 111, 204, 52, 118, 20, 203, 240, 246, 176, 192, 173, 55, 49, 22, 172, 223, 237, 182, 82, 115, 100, 154, 106, 111, 233, 128, 12, 175, 167, 115, 204, 64, 213, 69, 88, 132, 38, 246, 90, 114, 65, 216, 162, 245, 96, 172, 131, 76, 39, 17, 205, 145, 18, 223, 191, 98, 156, 144, 155, 154, 140, 25 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("394f9923-814a-426e-977f-c8082b6c4451"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("87f0867e-6cee-47e1-a3bb-588fcbdd731c")
                        });
                });
