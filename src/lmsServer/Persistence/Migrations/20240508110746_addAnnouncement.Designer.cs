...
namespace Persistence.Migrations
{
    ...
    [Migration("20240508110746_addAnnouncement")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f492bf8c-0c6c-48f6-829e-5977550d72a9"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 144, 135, 60, 35, 35, 98, 127, 131, 119, 25, 87, 20, 180, 23, 95, 4, 97, 208, 58, 233, 38, 148, 112, 0, 247, 163, 33, 204, 236, 163, 114, 28, 39, 253, 48, 180, 63, 25, 126, 100, 190, 202, 254, 208, 50, 184, 239, 116, 255, 11, 170, 252, 179, 203, 250, 221, 75, 75, 118, 169, 222, 221, 9, 75 },
                            PasswordSalt = new byte[] { 199, 171, 136, 95, 1, 155, 244, 130, 230, 125, 100, 168, 169, 172, 67, 242, 17, 18, 95, 247, 107, 2, 181, 93, 0, 208, 251, 125, 6, 225, 64, 52, 241, 38, 182, 26, 204, 221, 60, 181, 149, 113, 168, 243, 240, 49, 130, 222, 59, 151, 106, 181, 246, 181, 73, 163, 139, 192, 191, 200, 78, 213, 194, 26, 202, 6, 12, 13, 185, 74, 9, 119, 158, 67, 186, 219, 201, 137, 119, 233, 78, 230, 245, 12, 177, 73, 144, 77, 20, 56, 92, 203, 182, 187, 230, 84, 198, 30, 180, 16, 161, 229, 185, 100, 165, 8, 74, 203, 115, 11, 91, 93, 249, 27, 174, 178, 33, 12, 188, 221, 167, 252, 169, 236, 176, 239, 94, 116 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2e26b055-1fcf-49a1-bfd3-805816ee45e7"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("f492bf8c-0c6c-48f6-829e-5977550d72a9")
                        });
                });
