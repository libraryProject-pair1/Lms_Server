...
namespace Persistence.Migrations
{
    ...
    [Migration("20240509182438_AddedInfoForRegisterLoginMember")]
    partial class AddedInfoForRegisterLoginMember
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("833904c8-dd27-4a1d-ba46-94e9044f5b96"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 70, 169, 234, 69, 174, 45, 174, 199, 136, 153, 36, 146, 246, 166, 240, 116, 227, 135, 187, 28, 245, 246, 131, 138, 208, 76, 0, 85, 171, 249, 50, 140, 7, 70, 151, 111, 31, 0, 225, 113, 91, 11, 26, 231, 82, 96, 88, 204, 103, 98, 82, 107, 221, 208, 60, 132, 15, 49, 87, 17, 240, 40, 122, 174 },
                            PasswordSalt = new byte[] { 94, 225, 38, 217, 82, 73, 166, 128, 118, 41, 53, 2, 188, 56, 66, 60, 192, 151, 57, 157, 72, 79, 220, 154, 222, 154, 31, 95, 130, 27, 183, 200, 61, 59, 40, 14, 101, 88, 113, 217, 56, 18, 23, 35, 185, 192, 64, 221, 193, 87, 127, 190, 161, 178, 48, 76, 210, 197, 114, 14, 116, 210, 190, 63, 193, 49, 109, 150, 38, 175, 71, 252, 71, 113, 199, 220, 137, 239, 156, 52, 119, 98, 240, 124, 46, 79, 38, 35, 85, 65, 246, 27, 131, 205, 17, 55, 163, 95, 150, 174, 123, 169, 210, 195, 231, 231, 117, 214, 151, 204, 45, 210, 242, 27, 248, 47, 251, 233, 62, 214, 228, 70, 103, 37, 170, 84, 212, 202 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("89b88958-848b-45a1-86b0-0f8aa3c6ff1f"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("833904c8-dd27-4a1d-ba46-94e9044f5b96")
                        });
                });
